...
빠른 UI 구현을 위해 Vuetify를 사용했으나, 그럼에도 완성도 있는 결과물을 위해서는 디자인을 전문으로 하는 인력이 필요함을 절실히 깨달았다. <br>
전체적인 마크업을 잡아 두고 함께 한 팀원이 Vuetify 커스텀을 진행해 주었는데 확실히 아름다운 디자인이 있어야 기능도 돋보인다는 것을 느꼈다. <br>
나 또한 전문적인 디자이너만큼 감각을 익히려면 시간이 오래 걸리겠지만 꾸준히 관심을 가지며 **보는 눈**을 길러야겠다고 생각했다.

### UX 개선에는 끝이 없다

리팩토링의 중요성을 프로젝트 마무리 단계에서 다시금 되새겼는데, UX 향상의 관점에서였다. <br>
로그인 전 사용자에게 어디까지 서비스에 대한 기능을 오픈할 것이고, 언제 어떻게 로그인을 유도하는지에 따라 매끄러운 UX가 될 수도 있고 그렇지 않을 수도 있다는 걸 느꼈다. <br>
보여지는 기능만을 구현했다고 끝이 아닌 끊임없는 리팩토링에서 보다 완성도 있는 서비스가 탄생하는 것임을 알고, 짜여진 코드도 또 뜯어보고 살펴보는 것을 게을리 하지 않아야겠다고 생각했다.
